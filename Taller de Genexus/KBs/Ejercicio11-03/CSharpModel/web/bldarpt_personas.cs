...
using System.IO;
public class bldarpt_personas : GxBaseBuilder
{
   string cs_path = "." ;
   public bldarpt_personas( ) : base()
   {
   }
   ...
   {
      bldarpt_personas x = new bldarpt_personas() ;
      x.SetMainSourceFile( "arpt_personas.cs");
