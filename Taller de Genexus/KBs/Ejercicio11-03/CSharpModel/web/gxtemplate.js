gx.plugdesign.definition = {
	...
	class_maps:[
		...
		{
			selector:'.gx-attribute > input:not(.GeoLocOption):not([type="image"]), .gx-attribute > select, .gx-attribute > textarea',
		...
		// Buttons
		{
			selector:'.gx-button input, input[type="button"], .gx-grid-paging-bar button',
