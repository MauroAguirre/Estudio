/*
               File: ViewEstudiante
        Description: View Estudiante
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 3/14/2019 20:7:2.89
...
namespace GeneXus.Programs {
   public class viewestudiante : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public viewestudiante( IGxContext context )
      {
      ...
      public void execute( short aP0_EstudianteNumero ,
                           String aP1_TabCode )
      {
         this.AV12EstudianteNumero = aP0_EstudianteNumero;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12EstudianteNumero = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12EstudianteNumero", StringUtil.LTrim( StringUtil.Str( (decimal)(AV12EstudianteNumero), 4, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vESTUDIANTENUMERO", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EstudianteNumero), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2019314207293", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewestudiante.aspx") + "?" + UrlEncode("" +AV12EstudianteNumero) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode))+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vESTUDIANTENUMERO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12EstudianteNumero), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vESTUDIANTENUMERO", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EstudianteNumero), "ZZZ9"), context));
      ...
      {
         return formatLink("viewestudiante.aspx") + "?" + UrlEncode("" +AV12EstudianteNumero) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode)) ;
      }

      public override String GetPgmname( )
      {
         return "ViewEstudiante" ;
      }
      ...
      protected void WB0F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Estudiante Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_ViewEstudiante.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Estudiantes", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, "HLP_ViewEstudiante.htm");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtEstudiantePersonaNombre_Internalname, StringUtil.RTrim( A21EstudiantePersonaNombre), StringUtil.RTrim( context.localUtil.Format( A21EstudiantePersonaNombre, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEstudiantePersonaNombre_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtEstudiantePersonaNombre_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_ViewEstudiante.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewEstudiante.htm");
            /* Div Control */
      ...
      protected void START0F2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Estudiante", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF0F2( )
      {
         ...
         {
            /* Using cursor H000F2 */
            pr_default.execute(0, new Object[] {AV12EstudianteNumero});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A20EstudiantePersonaId = H000F2_A20EstudiantePersonaId[0];
               A11EstudianteNumero = H000F2_A11EstudianteNumero[0];
               A21EstudiantePersonaNombre = H000F2_A21EstudiantePersonaNombre[0];
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A21EstudiantePersonaNombre", A21EstudiantePersonaNombre);
               n21EstudiantePersonaNombre = H000F2_n21EstudiantePersonaNombre[0];
               A21EstudiantePersonaNombre = H000F2_A21EstudiantePersonaNombre[0];
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A21EstudiantePersonaNombre", A21EstudiantePersonaNombre);
               n21EstudiantePersonaNombre = H000F2_n21EstudiantePersonaNombre[0];
               /* Execute user event: Load */
      ...
      protected void STRUP0F0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A21EstudiantePersonaNombre", A21EstudiantePersonaNombre);
            /* Read saved values. */
            AV12EstudianteNumero = (short)(context.localUtil.CToN( cgiGet( "vESTUDIANTENUMERO"), ".", ","));
      ...
      protected void E110F2( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H000F3 */
         pr_default.execute(1, new Object[] {AV12EstudianteNumero});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A20EstudiantePersonaId = H000F3_A20EstudiantePersonaId[0];
            A11EstudianteNumero = H000F3_A11EstudianteNumero[0];
            A21EstudiantePersonaNombre = H000F3_A21EstudiantePersonaNombre[0];
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A21EstudiantePersonaNombre", A21EstudiantePersonaNombre);
            n21EstudiantePersonaNombre = H000F3_n21EstudiantePersonaNombre[0];
            A21EstudiantePersonaNombre = H000F3_A21EstudiantePersonaNombre[0];
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A21EstudiantePersonaNombre", A21EstudiantePersonaNombre);
            n21EstudiantePersonaNombre = H000F3_n21EstudiantePersonaNombre[0];
            AV16GXLvl6 = 1;
            Form.Caption = A21EstudiantePersonaNombre;
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwestudiante.aspx") ;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "EstudianteGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "estudiantegeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "EstudianteGeneral";
               WebComp_Generalwc_Component = "EstudianteGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0030",(String)"",(short)AV12EstudianteNumero});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12EstudianteNumero = Convert.ToInt16(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12EstudianteNumero", StringUtil.LTrim( StringUtil.Str( (decimal)(AV12EstudianteNumero), 4, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vESTUDIANTENUMERO", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EstudianteNumero), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2019314207334", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewestudiante.js", "?2019314207334", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12EstudianteNumero',fld:'vESTUDIANTENUMERO',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000F2_A20EstudiantePersonaId = new short[1] ;
         H000F2_A11EstudianteNumero = new short[1] ;
         H000F2_A21EstudiantePersonaNombre = new String[] {""} ;
         H000F2_n21EstudiantePersonaNombre = new bool[] {false} ;
         H000F3_A20EstudiantePersonaId = new short[1] ;
         H000F3_A11EstudianteNumero = new short[1] ;
         H000F3_A21EstudiantePersonaNombre = new String[] {""} ;
         H000F3_n21EstudiantePersonaNombre = new bool[] {false} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewestudiante__default(),
            new Object[][] {
                new Object[] {
               H000F2_A20EstudiantePersonaId, H000F2_A11EstudianteNumero, H000F2_A21EstudiantePersonaNombre, H000F2_n21EstudiantePersonaNombre
               }
               , new Object[] {
               H000F3_A20EstudiantePersonaId, H000F3_A11EstudianteNumero, H000F3_A21EstudiantePersonaNombre, H000F3_n21EstudiantePersonaNombre
               }
            }
         );
      ...
      private short AV12EstudianteNumero ;
      private short wcpOAV12EstudianteNumero ;
      ...
      private short[] H000F2_A20EstudiantePersonaId ;
      private short[] H000F2_A11EstudianteNumero ;
      private String[] H000F2_A21EstudiantePersonaNombre ;
      private bool[] H000F2_n21EstudiantePersonaNombre ;
      private short[] H000F3_A20EstudiantePersonaId ;
      private short[] H000F3_A11EstudianteNumero ;
      private String[] H000F3_A21EstudiantePersonaNombre ;
      private bool[] H000F3_n21EstudiantePersonaNombre ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewestudiante__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV12EstudianteNumero",SqlDbType.SmallInt,4,0}
          } ;
          Object[] prmH000F3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H000F2", "SELECT T1.[EstudiantePersonaId] AS EstudiantePersonaId, T1.[EstudianteNumero], T2.[PersonaNombre] AS EstudiantePersonaNombre FROM ([Estudiante] T1 WITH (NOLOCK) INNER JOIN [Persona] T2 WITH (NOLOCK) ON T2.[PersonaId] = T1.[EstudiantePersonaId]) WHERE T1.[EstudianteNumero] = @AV12EstudianteNumero ORDER BY T1.[EstudianteNumero] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000F2,1,0,true,true )
             ,new CursorDef("H000F3", "SELECT T1.[EstudiantePersonaId] AS EstudiantePersonaId, T1.[EstudianteNumero], T2.[PersonaNombre] AS EstudiantePersonaNombre FROM ([Estudiante] T1 WITH (NOLOCK) INNER JOIN [Persona] T2 WITH (NOLOCK) ON T2.[PersonaId] = T1.[EstudiantePersonaId]) WHERE T1.[EstudianteNumero] = @AV12EstudianteNumero ORDER BY T1.[EstudianteNumero] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000F3,1,0,false,true )
          };
       }
    }
