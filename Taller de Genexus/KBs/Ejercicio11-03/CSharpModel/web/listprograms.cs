/*
       ...
       Generated on: 3/14/2019 20:6:59.13
...
namespace GeneXus.Programs {
   public class listprograms : GXProcedure
   {
      ...
      {
         this.AV9ProgramNames = new GXBaseCollection<SdtProgramNames_ProgramName>( context, "ProgramName", "Ejercicio1103") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( out GXBaseCollection<SdtProgramNames_ProgramName> aP0_ProgramNames )
      {
         ...
         objlistprograms.AV9ProgramNames = new GXBaseCollection<SdtProgramNames_ProgramName>( context, "ProgramName", "Ejercicio1103") ;
      ...
      void executePrivate( )
      {
         ...
         AV9ProgramNames = new GXBaseCollection<SdtProgramNames_ProgramName>( context, "ProgramName", "Ejercicio1103");
         AV11name = "WWEstudiante";
         AV12description = "Estudiantes";
         AV13link = "wwestudiante.aspx";
