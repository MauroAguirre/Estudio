...
namespace GeneXus.Programs {
   public class wwactividad : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwactividad( )
      {
      ...
      public wwactividad( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV13ActividadDescripcion = GetNextPar( );
               ...
               gxgrGrid_refresh( subGrid_Rows, AV13ActividadDescripcion, AV19Pgmname, AV14Update, AV15Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwactividad.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vACTIVIDADDESCRIPCION", StringUtil.RTrim( AV13ActividadDescripcion));
         /* Send saved values. */
      ...
      {
         return formatLink("wwactividad.aspx")  ;
      }
      ...
      protected void WB0A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWActividad.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavActividaddescripcion_Internalname, "Actividad Descripcion", "col-sm-3 FilterSearchAttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavActividaddescripcion_Internalname, StringUtil.RTrim( AV13ActividadDescripcion), StringUtil.RTrim( context.localUtil.Format( AV13ActividadDescripcion, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Descripcion", edtavActividaddescripcion_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavActividaddescripcion_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_WWActividad.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Actividaddescripcion Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vACTIVIDADDESCRIPCION"), AV13ActividadDescripcion) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0A2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavActividaddescripcion_Internalname;
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       String AV13ActividadDescripcion ,
                                       String AV19Pgmname ,
                                       String AV14Update ,
                                       String AV15Delete )
      {
      ...
      protected void RF0A2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV13ActividadDescripcion ,
                                                 A13ActividadDescripcion } ,
                                                 new int[]{
                                                 TypeConstants.STRING, TypeConstants.STRING
                                                 }
            } ) ;
            lV13ActividadDescripcion = StringUtil.PadR( StringUtil.RTrim( AV13ActividadDescripcion), 20, "%");
            /* Using cursor H000A2 */
            pr_default.execute(0, new Object[] {lV13ActividadDescripcion, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_25_idx), 4, 0)), 4, "0");
            SubsflControlProps_252( ) ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_ACTIVIDADID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A1ActividadId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_Recordcount( )
      {
         ...
         lV13ActividadDescripcion = StringUtil.PadR( StringUtil.RTrim( AV13ActividadDescripcion), 20, "%");
         /* Using cursor H000A3 */
         pr_default.execute(1, new Object[] {lV13ActividadDescripcion});
      ...
      protected void STRUP0A0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13ActividadDescripcion = cgiGet( edtavActividaddescripcion_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13ActividadDescripcion", AV13ActividadDescripcion);
            /* Read saved values. */
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("actividad.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +A1ActividadId);
         edtavDelete_Link = formatLink("actividad.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +A1ActividadId);
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("actividad.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +0));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(AV7HTTPRequest.Method, "GET") == 0 )
         {
            ...
            {
               AV13ActividadDescripcion = ((SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(1)).gxTpr_Value;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13ActividadDescripcion", AV13ActividadDescripcion);
            }
      ...
      protected void S132( )
      {
         ...
         AV9GridStateFilterValue.gxTpr_Value = AV13ActividadDescripcion;
      ...
      protected void S112( )
      {
         ...
         AV11TrnContext.gxTpr_Transactionname = "Actividad";
      ...
      protected void init_default_properties( )
      {
         ...
         edtavActividaddescripcion_Internalname = "vACTIVIDADDESCRIPCION";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavActividaddescripcion_Jsonclick = "";
         edtavActividaddescripcion_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:''},{av:'AV13ActividadDescripcion',fld:'vACTIVIDADDESCRIPCION',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E140A2',iparms:[{av:'A1ActividadId',fld:'ACTIVIDADID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtActividadDescripcion_Link',ctrl:'ACTIVIDADDESCRIPCION',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110A2',iparms:[{av:'A1ActividadId',fld:'ACTIVIDADID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:''},{av:'AV13ActividadDescripcion',fld:'vACTIVIDADDESCRIPCION',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:''},{av:'AV13ActividadDescripcion',fld:'vACTIVIDADDESCRIPCION',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:''},{av:'AV13ActividadDescripcion',fld:'vACTIVIDADDESCRIPCION',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:''},{av:'AV13ActividadDescripcion',fld:'vACTIVIDADDESCRIPCION',pic:''}]");
      ...
      private String AV13ActividadDescripcion ;
      ...
      private String edtavActividaddescripcion_Internalname ;
      private String edtavActividaddescripcion_Jsonclick ;
      ...
      private String lV13ActividadDescripcion ;
   ...
   public class wwactividad__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             String A13ActividadDescripcion )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13ActividadDescripcion)) )
         {
            ...
            {
               sWhereString = sWhereString + " and ([ActividadDescripcion] like @lV13ActividadDescripcion)";
            }
            else
            {
               sWhereString = sWhereString + " ([ActividadDescripcion] like @lV13ActividadDescripcion)";
            }
         }
         else
         {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV13ActividadDescripcion",SqlDbType.Char,20,0} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H000A2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000A2,11,0,true,false )
             ,new CursorDef("H000A3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000A3,1,0,true,false )
          };
       }
    }
