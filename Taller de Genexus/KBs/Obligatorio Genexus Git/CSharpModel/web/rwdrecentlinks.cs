/*
       ...
       Generated on: 3/22/2019 19:0:38.73
...
namespace GeneXus.Programs {
   public class rwdrecentlinks : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20193221904063", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm052( )
      {
         ...
         {
            context.AddJavascriptSource("rwdrecentlinks.js", "?20193221904064", false);
         }
      ...
      {
         /* Links_Load Routine */
         AV11RecentLinksItems.FromXml(AV8Session.Get("RecentLinks"), null, "LinkList", "ObligatorioGenexusGit");
         AV9i = 1;
         ...
         AV8Session.Set("RecentLinks", AV11RecentLinksItems.ToXml(false, true, "LinkList", "ObligatorioGenexusGit"));
         AV9i = 1;
         while ( AV9i <= AV11RecentLinksItems.Count )
         {
            AV12RecentLinksItem = ((SdtLinkList_LinkItem)AV11RecentLinksItems.Item(AV9i));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20193221904089", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("rwdrecentlinks.js", "?20193221904089", false);
      ...
      protected void sendrow_82( )
      {
         ...
         else if ( subLinks_Backcolorstyle == 3 )
         {
            ...
            subLinks_Backstyle = 1;
            if ( ((int)(((nGXsfl_8_idx-1)/ (decimal)(0)) % (2))) == 0 )
            {
               subLinks_Backcolor = (int)(0xFFFFFF);
               if ( StringUtil.StrCmp(subLinks_Class, "") != 0 )
               {
         ...
         /* Table start */
         LinksRow.AddColumnProperties("table", -1, isAjaxCallMode( ), new Object[] {(String)tblLinkstable_Internalname+"_"+sGXsfl_8_idx,(short)1,(String)"RecentLinksTable",(String)"",(String)"",(String)"",(String)"",(String)"",(String)"",(short)1,(short)2,(String)"",(String)"",(String)"",(String)"px",(String)"px",(String)""});
         LinksRow.AddColumnProperties("row", -1, isAjaxCallMode( ), new Object[] {(String)"",(String)"",(String)""});
         LinksRow.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {(String)"",(String)""});
         /* Text block */
      ...
      protected void init_default_properties( )
      {
         ...
         tblLinkstable_Internalname = sPrefix+"LINKSTABLE";
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "";
         sEvtType = "";
         AV11RecentLinksItems = new GXBaseCollection<SdtLinkList_LinkItem>( context, "LinkItem", "ObligatorioGenexusGit");
      ...
      private String tblLinkstable_Internalname ;
