/*
               File: SocioSociosWC
        Description: Socio Socios WC
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 4/12/2019 21:1:42.12
...
namespace GeneXus.Programs {
   public class sociosocioswc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public sociosocioswc( )
      {
      ...
      public sociosocioswc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV6SocioId, AV11Update, AV12Delete, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Socio Socios WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?20194122114216", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("sociosocioswc.aspx") + "?" + UrlEncode("" +AV6SocioId)+"\">") ;
      ...
      protected void RenderHtmlCloseForm182( )
      {
         ...
         {
            context.AddJavascriptSource("sociosocioswc.js", "?20194122114218", false);
         }
      ...
      {
         return "SocioSociosWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Socio Socios WC" ;
      }
      ...
      protected void WB180( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "sociosocioswc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_SocioSociosWC.htm");
         ...
         if ( wbEnd == 20 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtSocioId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A5SocioId), 4, 0, ".", "")), ((edtSocioId_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A5SocioId), "ZZZ9")) : context.localUtil.Format( (decimal)(A5SocioId), "ZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSocioId_Jsonclick, 0, "Attribute", "", "", "", "", edtSocioId_Visible, edtSocioId_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_SocioSociosWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START182( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Socio Socios WC", 0) ;
            }
            context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_CLASEID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A3ClaseId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"CLASEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A3ClaseId), 4, 0, ".", "")));
      }
      ...
      protected void RF182( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_Recordsperpage( ) ) ) ) )
            {
               ...
               A15ProfesorNombre = H00182_A15ProfesorNombre[0];
               A2ProfesorId = H00182_A2ProfesorId[0];
               A13ActividadDescripcion = H00182_A13ActividadDescripcion[0];
               A1ActividadId = H00182_A1ActividadId[0];
               A3ClaseId = H00182_A3ClaseId[0];
               A2ProfesorId = H00182_A2ProfesorId[0];
               A15ProfesorNombre = H00182_A15ProfesorNombre[0];
               A1ActividadId = H00182_A1ActividadId[0];
               A13ActividadDescripcion = H00182_A13ActividadDescripcion[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_CLASEID"+"_"+sGXsfl_20_idx, GetSecureSignedToken( sPrefix+sGXsfl_20_idx, context.localUtil.Format( (decimal)(A3ClaseId), "ZZZ9"), context));
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Clase";
         AV10TrnContextAtt = new SdtTransactionContext_Attribute(context);
         AV10TrnContextAtt.gxTpr_Attributename = "SocioId";
         AV10TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6SocioId), 4, 0);
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "sociosocioswc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20194122114257", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("sociosocioswc.js", "?20194122114257", false);
         }
      ...
      {
         edtClaseId_Internalname = sPrefix+"CLASEID_"+sGXsfl_20_idx;
      ...
      {
         edtClaseId_Internalname = sPrefix+"CLASEID_"+sGXsfl_20_fel_idx;
      ...
      protected void sendrow_202( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtClaseId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A3ClaseId), 4, 0, ".", "")),context.localUtil.Format( (decimal)(A3ClaseId), "ZZZ9"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)edtClaseId_Link,(String)"",(String)"",(String)"",(String)edtClaseId_Jsonclick,(short)0,(String)"DescriptionAttribute",(String)"",(String)ROClassString,(String)"WWColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtClaseId_Internalname = sPrefix+"CLASEID";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6SocioId',fld:'vSOCIOID',pic:'ZZZ9'},{av:'AV11Update',fld:'vUPDATE',pic:''},{av:'AV12Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E13182',iparms:[{av:'A3ClaseId',fld:'CLASEID',pic:'ZZZ9',hsh:true},{av:'A1ActividadId',fld:'ACTIVIDADID',pic:'ZZZ9'},{av:'A2ProfesorId',fld:'PROFESORID',pic:'ZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtClaseId_Link',ctrl:'CLASEID',prop:'Link'},{av:'edtActividadDescripcion_Link',ctrl:'ACTIVIDADDESCRIPCION',prop:'Link'},{av:'edtProfesorNombre_Link',ctrl:'PROFESORNOMBRE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E11182',iparms:[{av:'A3ClaseId',fld:'CLASEID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6SocioId',fld:'vSOCIOID',pic:'ZZZ9'},{av:'AV11Update',fld:'vUPDATE',pic:''},{av:'AV12Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6SocioId',fld:'vSOCIOID',pic:'ZZZ9'},{av:'AV11Update',fld:'vUPDATE',pic:''},{av:'AV12Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6SocioId',fld:'vSOCIOID',pic:'ZZZ9'},{av:'AV11Update',fld:'vUPDATE',pic:''},{av:'AV12Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6SocioId',fld:'vSOCIOID',pic:'ZZZ9'},{av:'AV11Update',fld:'vUPDATE',pic:''},{av:'AV12Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H00182_A5SocioId = new short[1] ;
         H00182_A15ProfesorNombre = new String[] {""} ;
         H00182_A2ProfesorId = new short[1] ;
         H00182_A13ActividadDescripcion = new String[] {""} ;
         H00182_A1ActividadId = new short[1] ;
         H00182_A3ClaseId = new short[1] ;
         ...
         sCtrlAV6SocioId = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.sociosocioswc__default(),
            new Object[][] {
                new Object[] {
               H00182_A5SocioId, H00182_A15ProfesorNombre, H00182_A2ProfesorId, H00182_A13ActividadDescripcion, H00182_A1ActividadId, H00182_A3ClaseId
               }
               , new Object[] {
      ...
      private short[] H00182_A5SocioId ;
      private String[] H00182_A15ProfesorNombre ;
      private short[] H00182_A2ProfesorId ;
      private String[] H00182_A13ActividadDescripcion ;
      private short[] H00182_A1ActividadId ;
      private short[] H00182_A3ClaseId ;
   ...
   public class sociosocioswc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00182", "SELECT T1.[SocioId], T3.[ProfesorNombre], T2.[ProfesorId], T4.[ActividadDescripcion], T3.[ActividadId], T1.[ClaseId] FROM ((([ClaseSocios] T1 WITH (NOLOCK) INNER JOIN [Clase] T2 WITH (NOLOCK) ON T2.[ClaseId] = T1.[ClaseId]) INNER JOIN [Profesor] T3 WITH (NOLOCK) ON T3.[ProfesorId] = T2.[ProfesorId]) INNER JOIN [Actividad1] T4 WITH (NOLOCK) ON T4.[ActividadId] = T3.[ActividadId]) WHERE T1.[SocioId] = @AV6SocioId ORDER BY T1.[SocioId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00182,11,0,true,false )
             ,new CursorDef("H00183", "SELECT COUNT(*) FROM ((([ClaseSocios] T1 WITH (NOLOCK) INNER JOIN [Clase] T2 WITH (NOLOCK) ON T2.[ClaseId] = T1.[ClaseId]) INNER JOIN [Profesor] T3 WITH (NOLOCK) ON T3.[ProfesorId] = T2.[ProfesorId]) INNER JOIN [Actividad1] T4 WITH (NOLOCK) ON T4.[ActividadId] = T3.[ActividadId]) WHERE T1.[SocioId] = @AV6SocioId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00183,1,0,true,false )
          };
       }
    }
