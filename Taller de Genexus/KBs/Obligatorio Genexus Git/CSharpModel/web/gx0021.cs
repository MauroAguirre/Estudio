...
namespace GeneXus.Programs {
   public class gx0021 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public void execute( short aP0_pActividadId ,
                           out short aP1_pSocioId )
      {
         this.AV7pActividadId = aP0_pActividadId;
         this.AV8pSocioId = 0 ;
         executePrivate();
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV7pActividadId = (short)(NumberUtil.Val( GetNextPar( ), "."));
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1;
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cSocioId, AV7pActividadId) ;
            ...
            {
               AV7pActividadId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7pActividadId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV7pActividadId), 4, 0)));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0021.aspx") + "?" + UrlEncode("" +AV7pActividadId) + "," + UrlEncode("" +AV8pSocioId)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPACTIVIDADID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7pActividadId), 4, 0, ".", "")));
      ...
      {
         return formatLink("gx0021.aspx") + "?" + UrlEncode("" +AV7pActividadId) + "," + UrlEncode("" +AV8pSocioId) ;
      }
      ...
      {
         return "Selection List Socio En Actividad" ;
      }
      ...
      protected void WB0X0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblsocioidfilter_Internalname, "Socio Id", "", "", lblLblsocioidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110x1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx0021.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e120x1_client"+"'", TempTags, "", 2, "HLP_Gx0021.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         if ( wbEnd == 24 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "Cancel", bttBtn_cancel_Jsonclick, 1, "Cancel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx0021.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START0X2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Selection List Socio En Actividad", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF0X2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H000X2 */
            pr_default.execute(0, new Object[] {AV7pActividadId, AV6cSocioId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_24_idx = 1;
            sGXsfl_24_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_24_idx), 4, 0)), 4, "0");
            SubsflControlProps_242( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subGrid1_Recordsperpage( ) ) ) ) )
            {
               A1ActividadId = H000X2_A1ActividadId[0];
               A5SocioId = H000X2_A5SocioId[0];
               /* Execute user event: Load */
               E140X2 ();
      ...
      {
         /* Using cursor H000X3 */
         pr_default.execute(1, new Object[] {AV7pActividadId, AV6cSocioId});
      ...
      {
         /* Start Routine */
         Form.Caption = StringUtil.Format( "Selection List %1", "Socio En Actividad", "", "", "", "", "", "", "", "");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV7pActividadId = Convert.ToInt16(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7pActividadId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV7pActividadId), 4, 0)));
      ...
      protected void SubsflControlProps_242( )
      {
         ...
         edtActividadId_Internalname = "ACTIVIDADID_"+sGXsfl_24_idx;
      }
      ...
      protected void SubsflControlProps_fel_242( )
      {
         ...
         edtActividadId_Internalname = "ACTIVIDADID_"+sGXsfl_24_fel_idx;
      }
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Selection List Socio En Actividad";
         subGrid1_Rows = 10;
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cSocioId',fld:'vCSOCIOID',pic:'ZZZ9'},{av:'AV7pActividadId',fld:'vPACTIVIDADID',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E120X1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLSOCIOIDFILTER.CLICK","{handler:'E110X1',iparms:[{av:'divSocioidfiltercontainer_Class',ctrl:'SOCIOIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E150X2',iparms:[{av:'A5SocioId',fld:'SOCIOID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8pSocioId',fld:'vPSOCIOID',pic:'ZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cSocioId',fld:'vCSOCIOID',pic:'ZZZ9'},{av:'AV7pActividadId',fld:'vPACTIVIDADID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cSocioId',fld:'vCSOCIOID',pic:'ZZZ9'},{av:'AV7pActividadId',fld:'vPACTIVIDADID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cSocioId',fld:'vCSOCIOID',pic:'ZZZ9'},{av:'AV7pActividadId',fld:'vPACTIVIDADID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cSocioId',fld:'vCSOCIOID',pic:'ZZZ9'},{av:'AV7pActividadId',fld:'vPACTIVIDADID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H000X2_A1ActividadId = new short[1] ;
         H000X2_A5SocioId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0021__default(),
            new Object[][] {
                new Object[] {
               H000X2_A1ActividadId, H000X2_A5SocioId
               }
               , new Object[] {
      ...
      private short AV7pActividadId ;
      private short wcpOAV7pActividadId ;
      ...
      private short[] H000X2_A1ActividadId ;
      private short[] H000X2_A5SocioId ;
   ...
   public class gx0021__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV7pActividadId",SqlDbType.SmallInt,4,0} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H000X2", "SELECT [ActividadId], [SocioId] FROM [ActividadSocioEnActividad] WITH (NOLOCK) WHERE [ActividadId] = @AV7pActividadId and [SocioId] >= @AV6cSocioId ORDER BY [ActividadId], [SocioId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000X2,11,0,false,false )
             ,new CursorDef("H000X3", "SELECT COUNT(*) FROM [ActividadSocioEnActividad] WITH (NOLOCK) WHERE [ActividadId] = @AV7pActividadId and [SocioId] >= @AV6cSocioId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000X3,1,0,false,false )
          };
       }
    }
