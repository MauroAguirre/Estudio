...
namespace GeneXus.Programs {
   public class ingresarcliente : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public ingresarcliente( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("ingresarcliente.aspx") +"\">") ;
      ...
      {
         return formatLink("ingresarcliente.aspx")  ;
      }
      ...
      protected void START0U2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Ingresar Cliente", 0) ;
         }
         context.wjLoc = "";
