/*
               File: SocioCarneWC
        Description: Socio Carne WC
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 3/22/2019 19:1:3.15
...
namespace GeneXus.Programs {
   public class sociocarnewc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public sociocarnewc( )
      {
      ...
      public sociocarnewc( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Socio Carne WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2019322191319", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("sociocarnewc.aspx") + "?" + UrlEncode("" +AV6SocioId)+"\">") ;
      ...
      protected void RenderHtmlCloseForm0S2( )
      {
         ...
         {
            context.AddJavascriptSource("sociocarnewc.js", "?2019322191321", false);
         }
      ...
      protected void WB0S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "sociocarnewc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_SocioCarneWC.htm");
         ...
         if ( wbEnd == 20 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtSocioId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A5SocioId), 4, 0, ".", "")), ((edtSocioId_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A5SocioId), "ZZZ9")) : context.localUtil.Format( (decimal)(A5SocioId), "ZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSocioId_Jsonclick, 0, "Attribute", "", "", "", "", edtSocioId_Visible, edtSocioId_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_SocioCarneWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START0S2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Socio Carne WC", 0) ;
            }
            context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_CARNEID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A4CarneId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"CARNEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A4CarneId), 4, 0, ".", "")));
      }
      ...
      protected void RF0S2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_Recordsperpage( ) ) ) ) )
            {
               ...
               A22CarneFechaIngreso = H000S2_A22CarneFechaIngreso[0];
               A4CarneId = H000S2_A4CarneId[0];
               E130S2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_CARNEID"+"_"+sGXsfl_20_idx, GetSecureSignedToken( sPrefix+sGXsfl_20_idx, context.localUtil.Format( (decimal)(A4CarneId), "ZZZ9"), context));
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Carne";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "sociocarnewc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2019322191371", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("sociocarnewc.js", "?2019322191372", false);
         }
      ...
      {
         edtCarneId_Internalname = sPrefix+"CARNEID_"+sGXsfl_20_idx;
         edtCarneFechaIngreso_Internalname = sPrefix+"CARNEFECHAINGRESO_"+sGXsfl_20_idx;
      ...
      {
         edtCarneId_Internalname = sPrefix+"CARNEID_"+sGXsfl_20_fel_idx;
         edtCarneFechaIngreso_Internalname = sPrefix+"CARNEFECHAINGRESO_"+sGXsfl_20_fel_idx;
      ...
      protected void sendrow_202( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtCarneId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A4CarneId), 4, 0, ".", "")),context.localUtil.Format( (decimal)(A4CarneId), "ZZZ9"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtCarneId_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"AutoNumero",(String)"right",(bool)false});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtCarneFechaIngreso_Internalname,context.localUtil.Format(A22CarneFechaIngreso, "99/99/99"),context.localUtil.Format( A22CarneFechaIngreso, "99/99/99"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)edtCarneFechaIngreso_Link,(String)"",(String)"",(String)"",(String)edtCarneFechaIngreso_Jsonclick,(short)0,(String)"DescriptionAttribute",(String)"",(String)ROClassString,(String)"WWColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)8,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void init_default_properties( )
      {
         ...
         edtCarneId_Internalname = sPrefix+"CARNEID";
         edtCarneFechaIngreso_Internalname = sPrefix+"CARNEFECHAINGRESO";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E130S2',iparms:[{av:'A4CarneId',fld:'CARNEID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E110S2',iparms:[{av:'A4CarneId',fld:'CARNEID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H000S2_A5SocioId = new short[1] ;
         H000S2_A22CarneFechaIngreso = new DateTime[] {DateTime.MinValue} ;
         H000S2_A4CarneId = new short[1] ;
         ...
         sCtrlAV6SocioId = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.sociocarnewc__default(),
            new Object[][] {
                new Object[] {
               H000S2_A5SocioId, H000S2_A22CarneFechaIngreso, H000S2_A4CarneId
               }
               , new Object[] {
      ...
      private short[] H000S2_A5SocioId ;
      private DateTime[] H000S2_A22CarneFechaIngreso ;
      private short[] H000S2_A4CarneId ;
   ...
   public class sociocarnewc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000S2", "SELECT [SocioId], [CarneFechaIngreso], [CarneId] FROM [Carne] WITH (NOLOCK) WHERE [SocioId] = @AV6SocioId ORDER BY [SocioId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000S2,1,0,true,true )
             ,new CursorDef("H000S3", "SELECT COUNT(*) FROM [Carne] WITH (NOLOCK) WHERE [SocioId] = @AV6SocioId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000S3,1,0,true,true )
          };
       }
    }
