/*
               File: Gx00D1
        Description: Selection List Socios
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 4/12/2019 8:54:35.92
...
namespace GeneXus.Programs {
   public class gx00d1 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public void execute( short aP0_pClaseId ,
                           out short aP1_pSocioId )
      {
         this.AV7pClaseId = aP0_pClaseId;
         this.AV8pSocioId = 0 ;
         executePrivate();
         aP1_pSocioId=this.AV8pSocioId;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV7pClaseId = (short)(NumberUtil.Val( GetNextPar( ), "."));
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1;
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cSocioId, AV7pClaseId) ;
            ...
            {
               AV7pClaseId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7pClaseId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV7pClaseId), 4, 0)));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV8pSocioId = (short)(NumberUtil.Val( GetNextPar( ), "."));
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8pSocioId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV8pSocioId), 4, 0)));
               }
            }
            if ( context.isSpaRequest( ) )
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20194128543596", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx00d1.aspx") + "?" + UrlEncode("" +AV7pClaseId) + "," + UrlEncode("" +AV8pSocioId)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPCLASEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7pClaseId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vPSOCIOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8pSocioId), 4, 0, ".", "")));
      ...
      {
         return formatLink("gx00d1.aspx") + "?" + UrlEncode("" +AV7pClaseId) + "," + UrlEncode("" +AV8pSocioId) ;
      }
      ...
      protected void WB190( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblsocioidfilter_Internalname, "Socio Id", "", "", lblLblsocioidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11191_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx00D1.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e12191_client"+"'", TempTags, "", 2, "HLP_Gx00D1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         if ( wbEnd == 24 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "Cancel", bttBtn_cancel_Jsonclick, 1, "Cancel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx00D1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START192( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Selection List Socios", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF192( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00192 */
            pr_default.execute(0, new Object[] {AV7pClaseId, AV6cSocioId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_24_idx = 1;
            sGXsfl_24_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_24_idx), 4, 0)), 4, "0");
            SubsflControlProps_242( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subGrid1_Recordsperpage( ) ) ) ) )
            {
               A3ClaseId = H00192_A3ClaseId[0];
               A5SocioId = H00192_A5SocioId[0];
               /* Execute user event: Load */
               E14192 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_SOCIOID"+"_"+sGXsfl_24_idx, GetSecureSignedToken( sGXsfl_24_idx, context.localUtil.Format( (decimal)(A5SocioId), "ZZZ9"), context));
      }
      ...
      {
         /* Using cursor H00193 */
         pr_default.execute(1, new Object[] {AV7pClaseId, AV6cSocioId});
      ...
      {
         /* Start Routine */
         Form.Caption = StringUtil.Format( "Selection List %1", "Socios", "", "", "", "", "", "", "", "");
      ...
      {
         /* Enter Routine */
         AV8pSocioId = A5SocioId;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8pSocioId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV8pSocioId), 4, 0)));
         context.setWebReturnParms(new Object[] {(short)AV8pSocioId});
         context.setWebReturnParmsMetadata(new Object[] {"AV8pSocioId"});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV7pClaseId = Convert.ToInt16(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7pClaseId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV7pClaseId), 4, 0)));
         AV8pSocioId = Convert.ToInt16(getParm(obj,1));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8pSocioId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV8pSocioId), 4, 0)));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20194128543629", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00d1.js", "?20194128543629", false);
      ...
      protected void SubsflControlProps_242( )
      {
         ...
         edtSocioId_Internalname = "SOCIOID_"+sGXsfl_24_idx;
         edtClaseId_Internalname = "CLASEID_"+sGXsfl_24_idx;
      }

      protected void SubsflControlProps_fel_242( )
      {
         edtavLinkselection_Internalname = "vLINKSELECTION_"+sGXsfl_24_fel_idx;
         edtSocioId_Internalname = "SOCIOID_"+sGXsfl_24_fel_idx;
         edtClaseId_Internalname = "CLASEID_"+sGXsfl_24_fel_idx;
      }
      ...
      protected void sendrow_242( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_24_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtSocioId_Internalname, "Link", edtSocioId_Link, !bGXsfl_24_Refreshing);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Selection List Socios";
         subGrid1_Rows = 10;
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cSocioId',fld:'vCSOCIOID',pic:'ZZZ9'},{av:'AV7pClaseId',fld:'vPCLASEID',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E12191',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLSOCIOIDFILTER.CLICK","{handler:'E11191',iparms:[{av:'divSocioidfiltercontainer_Class',ctrl:'SOCIOIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E15192',iparms:[{av:'A5SocioId',fld:'SOCIOID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8pSocioId',fld:'vPSOCIOID',pic:'ZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cSocioId',fld:'vCSOCIOID',pic:'ZZZ9'},{av:'AV7pClaseId',fld:'vPCLASEID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cSocioId',fld:'vCSOCIOID',pic:'ZZZ9'},{av:'AV7pClaseId',fld:'vPCLASEID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cSocioId',fld:'vCSOCIOID',pic:'ZZZ9'},{av:'AV7pClaseId',fld:'vPCLASEID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cSocioId',fld:'vCSOCIOID',pic:'ZZZ9'},{av:'AV7pClaseId',fld:'vPCLASEID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00192_A3ClaseId = new short[1] ;
         H00192_A5SocioId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00d1__default(),
            new Object[][] {
                new Object[] {
               H00192_A3ClaseId, H00192_A5SocioId
               }
               , new Object[] {
      ...
      private short AV7pClaseId ;
      private short wcpOAV7pClaseId ;
      ...
      private short[] H00192_A3ClaseId ;
      private short[] H00192_A5SocioId ;
      private long[] H00193_AGRID1_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private short aP1_pSocioId ;
   ...
   public class gx00d1__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV7pClaseId",SqlDbType.SmallInt,4,0} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H00192", "SELECT [ClaseId], [SocioId] FROM [ClaseSocios] WITH (NOLOCK) WHERE [ClaseId] = @AV7pClaseId and [SocioId] >= @AV6cSocioId ORDER BY [ClaseId], [SocioId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00192,11,0,false,false )
             ,new CursorDef("H00193", "SELECT COUNT(*) FROM [ClaseSocios] WITH (NOLOCK) WHERE [ClaseId] = @AV7pClaseId and [SocioId] >= @AV6cSocioId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00193,1,0,false,false )
          };
       }
    }
