...
namespace GeneXus.Programs {
   public class viewclase : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewclase( )
      {
      ...
      public viewclase( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12ClaseId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12ClaseId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV12ClaseId), 4, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vCLASEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ClaseId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewclase.aspx") + "?" + UrlEncode("" +AV12ClaseId) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode))+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens = "hsh" + "ViewClase";
         forbiddenHiddens = forbiddenHiddens + context.localUtil.Format( (decimal)(A3ClaseId), "ZZZ9");
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens, GXKey));
         GXUtil.WriteLog("viewclase:[SendSecurityCheck value for]"+"ClaseId:"+context.localUtil.Format( (decimal)(A3ClaseId), "ZZZ9"));
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vCLASEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12ClaseId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCLASEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ClaseId), "ZZZ9"), context));
      ...
      {
         return formatLink("viewclase.aspx") + "?" + UrlEncode("" +AV12ClaseId) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode)) ;
      }
      ...
      protected void WB0K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Clase Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_ViewClase.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Clases", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, "HLP_ViewClase.htm");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtClaseId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A3ClaseId), 4, 0, ".", "")), ((edtClaseId_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A3ClaseId), "ZZZ9")) : context.localUtil.Format( (decimal)(A3ClaseId), "ZZZ9")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtClaseId_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtClaseId_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_ViewClase.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewClase.htm");
            /* Div Control */
      ...
      protected void START0K2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Clase", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF0K2( )
      {
         ...
         {
            /* Using cursor H000K2 */
            pr_default.execute(0, new Object[] {AV12ClaseId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A3ClaseId = H000K2_A3ClaseId[0];
      ...
      protected void STRUP0K0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A3ClaseId", StringUtil.LTrim( StringUtil.Str( (decimal)(A3ClaseId), 4, 0)));
            /* Read saved values. */
            AV12ClaseId = (short)(context.localUtil.CToN( cgiGet( "vCLASEID"), ".", ","));
            ...
            {
               GXUtil.WriteLog("viewclase:[SecurityCheckFailed value for]"+"ClaseId:"+context.localUtil.Format( (decimal)(A3ClaseId), "ZZZ9"));
               GxWebError = 1;
      ...
      protected void E110K2( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H000K3 */
         pr_default.execute(1, new Object[] {AV12ClaseId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A3ClaseId = H000K3_A3ClaseId[0];
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A3ClaseId", StringUtil.LTrim( StringUtil.Str( (decimal)(A3ClaseId), 4, 0)));
            AV16GXLvl6 = 1;
            Form.Caption = StringUtil.Str( (decimal)(A3ClaseId), 4, 0);
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwclase.aspx") ;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "ClaseGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "clasegeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "ClaseGeneral";
               WebComp_Generalwc_Component = "ClaseGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0030",(String)"",(short)AV12ClaseId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12ClaseId = Convert.ToInt16(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12ClaseId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV12ClaseId), 4, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vCLASEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ClaseId), "ZZZ9"), context));
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12ClaseId',fld:'vCLASEID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A3ClaseId',fld:'CLASEID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000K2_A3ClaseId = new short[1] ;
         hsh = "";
         H000K3_A3ClaseId = new short[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewclase__default(),
            new Object[][] {
                new Object[] {
               H000K2_A3ClaseId
               }
      ...
      private short AV12ClaseId ;
      private short wcpOAV12ClaseId ;
      ...
      private short[] H000K3_A3ClaseId ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewclase__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV12ClaseId",SqlDbType.SmallInt,4,0}
          } ;
          Object[] prmH000K3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H000K2", "SELECT [ClaseId] FROM [Clase] WITH (NOLOCK) WHERE [ClaseId] = @AV12ClaseId ORDER BY [ClaseId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000K2,1,0,true,true )
             ,new CursorDef("H000K3", "SELECT [ClaseId] FROM [Clase] WITH (NOLOCK) WHERE [ClaseId] = @AV12ClaseId ORDER BY [ClaseId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000K3,1,0,false,true )
          };
       }
    }
