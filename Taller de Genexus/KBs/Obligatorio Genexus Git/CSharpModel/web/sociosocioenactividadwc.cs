...
namespace GeneXus.Programs {
   public class sociosocioenactividadwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public sociosocioenactividadwc( )
      {
      ...
      public sociosocioenactividadwc( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV16Pgmname = "SocioSocioEnActividadWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Socio Socio En Actividad WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("sociosocioenactividadwc.aspx") + "?" + UrlEncode("" +AV6SocioId)+"\">") ;
      ...
      {
         return "SocioSocioEnActividadWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Socio Socio En Actividad WC" ;
      }
      ...
      protected void WB0R0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "sociosocioenactividadwc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_SocioSocioEnActividadWC.htm");
         ...
         if ( wbEnd == 20 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtSocioId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A5SocioId), 4, 0, ".", "")), ((edtSocioId_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A5SocioId), "ZZZ9")) : context.localUtil.Format( (decimal)(A5SocioId), "ZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSocioId_Jsonclick, 0, "Attribute", "", "", "", "", edtSocioId_Visible, edtSocioId_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_SocioSocioEnActividadWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START0R2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Socio Socio En Actividad WC", 0) ;
            }
            context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_ACTIVIDADID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A1ActividadId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"ACTIVIDADID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A1ActividadId), 4, 0, ".", "")));
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_ACTIVIDADID"+"_"+sGXsfl_20_idx, GetSecureSignedToken( sPrefix+sGXsfl_20_idx, context.localUtil.Format( (decimal)(A1ActividadId), "ZZZ9"), context));
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Actividad";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "sociosocioenactividadwc", GetJustCreated( ));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E130R2',iparms:[{av:'A1ActividadId',fld:'ACTIVIDADID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E110R2',iparms:[{av:'A1ActividadId',fld:'ACTIVIDADID',pic:'ZZZ9',hsh:true}]");
   ...
   public class sociosocioenactividadwc__default : DataStoreHelperBase, IDataStoreHelper
   {
