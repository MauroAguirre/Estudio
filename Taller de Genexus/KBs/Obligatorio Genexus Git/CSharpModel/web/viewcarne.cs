...
namespace GeneXus.Programs {
   public class viewcarne : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewcarne( )
      {
      ...
      public viewcarne( IGxContext context )
      {
      ...
      public void execute( short aP0_CarneId ,
                           String aP1_TabCode )
      {
         this.AV12CarneId = aP0_CarneId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12CarneId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12CarneId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV12CarneId), 4, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vCARNEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12CarneId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewcarne.aspx") + "?" + UrlEncode("" +AV12CarneId) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode))+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens = "hsh" + "ViewCarne";
         forbiddenHiddens = forbiddenHiddens + context.localUtil.Format(A22CarneFechaIngreso, "99/99/99");
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens, GXKey));
         GXUtil.WriteLog("viewcarne:[SendSecurityCheck value for]"+"CarneFechaIngreso:"+context.localUtil.Format(A22CarneFechaIngreso, "99/99/99"));
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vCARNEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12CarneId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCARNEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12CarneId), "ZZZ9"), context));
      ...
      {
         return formatLink("viewcarne.aspx") + "?" + UrlEncode("" +AV12CarneId) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode)) ;
      }
      ...
      protected void WB0H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Carne Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_ViewCarne.htm");
            ...
            GxWebStd.gx_label_element( context, edtCarneFechaIngreso_Internalname, "Fecha Ingreso", "col-sm-3 ReadonlyAttributeLabel", 1, true);
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtCarneFechaIngreso_Internalname, context.localUtil.Format(A22CarneFechaIngreso, "99/99/99"), context.localUtil.Format( A22CarneFechaIngreso, "99/99/99"), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCarneFechaIngreso_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtCarneFechaIngreso_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_ViewCarne.htm");
            GxWebStd.gx_bitmap( context, edtCarneFechaIngreso_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtCarneFechaIngreso_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_ViewCarne.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewCarne.htm");
            /* Div Control */
      ...
      protected void START0H2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Carne", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF0H2( )
      {
         ...
         {
            /* Using cursor H000H2 */
            pr_default.execute(0, new Object[] {AV12CarneId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A4CarneId = H000H2_A4CarneId[0];
               A22CarneFechaIngreso = H000H2_A22CarneFechaIngreso[0];
      ...
      protected void STRUP0H0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A22CarneFechaIngreso", context.localUtil.Format(A22CarneFechaIngreso, "99/99/99"));
            /* Read saved values. */
            AV12CarneId = (short)(context.localUtil.CToN( cgiGet( "vCARNEID"), ".", ","));
            ...
            {
               GXUtil.WriteLog("viewcarne:[SecurityCheckFailed value for]"+"CarneFechaIngreso:"+context.localUtil.Format(A22CarneFechaIngreso, "99/99/99"));
               GxWebError = 1;
      ...
      protected void E110H2( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H000H3 */
         pr_default.execute(1, new Object[] {AV12CarneId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A4CarneId = H000H3_A4CarneId[0];
            A22CarneFechaIngreso = H000H3_A22CarneFechaIngreso[0];
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A22CarneFechaIngreso", context.localUtil.Format(A22CarneFechaIngreso, "99/99/99"));
            AV16GXLvl6 = 1;
            Form.Caption = context.localUtil.DToC( A22CarneFechaIngreso, 1, "/");
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwcarne.aspx") ;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "CarneGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "carnegeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "CarneGeneral";
               WebComp_Generalwc_Component = "CarneGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0030",(String)"",(short)AV12CarneId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12CarneId = Convert.ToInt16(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12CarneId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV12CarneId), 4, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vCARNEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12CarneId), "ZZZ9"), context));
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12CarneId',fld:'vCARNEID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A22CarneFechaIngreso',fld:'CARNEFECHAINGRESO',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000H2_A4CarneId = new short[1] ;
         H000H2_A22CarneFechaIngreso = new DateTime[] {DateTime.MinValue} ;
         hsh = "";
         H000H3_A4CarneId = new short[1] ;
         H000H3_A22CarneFechaIngreso = new DateTime[] {DateTime.MinValue} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewcarne__default(),
            new Object[][] {
                new Object[] {
               H000H2_A4CarneId, H000H2_A22CarneFechaIngreso
               }
               , new Object[] {
               H000H3_A4CarneId, H000H3_A22CarneFechaIngreso
               }
            }
         );
      ...
      private short AV12CarneId ;
      private short wcpOAV12CarneId ;
      ...
      private short[] H000H2_A4CarneId ;
      private DateTime[] H000H2_A22CarneFechaIngreso ;
      private short[] H000H3_A4CarneId ;
      private DateTime[] H000H3_A22CarneFechaIngreso ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewcarne__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV12CarneId",SqlDbType.SmallInt,4,0}
          } ;
          Object[] prmH000H3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H000H2", "SELECT [CarneId], [CarneFechaIngreso] FROM [Carne] WITH (NOLOCK) WHERE [CarneId] = @AV12CarneId ORDER BY [CarneId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000H2,1,0,true,true )
             ,new CursorDef("H000H3", "SELECT [CarneId], [CarneFechaIngreso] FROM [Carne] WITH (NOLOCK) WHERE [CarneId] = @AV12CarneId ORDER BY [CarneId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000H3,1,0,false,true )
          };
       }
    }
