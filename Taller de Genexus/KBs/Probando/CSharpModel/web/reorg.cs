/*
       ...
       Generated on: 3/8/2019 21:8:30.68
...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void ReorganizeCliente( )
      {
         ...
         cmdBuffer=" ALTER TABLE [Cliente] ADD [ClienteEdad]  smallint NOT NULL CONSTRAINT ClienteEdadCliente_DEFAULT DEFAULT convert(int, 0) "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
         RGZ.Drop();
         cmdBuffer=" ALTER TABLE [Cliente] DROP CONSTRAINT ClienteEdadCliente_DEFAULT "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( ColumnExist("Cliente",sSchemaVar,"ClienteEdad") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_exist", new   object[]  {"ClienteEdad", "Cliente"}) ) ;
            return false ;
         }
         return true ;
      }
