			...
			case 2:
				if(img[imagen]==0){
					if(jugador==1){
						switch(playerImg1){
							case 0:
								document.getElementById(id).src="resources/aki.jpg";
								break;
							case 1:
								document.getElementById(id).src="resources/euforia.jpg";
								break;
							case 2:
								document.getElementById(id).src="resources/Kona.jpg";
								break;
							case 3:
								document.getElementById(id).src="resources/michika.jpg";
								break;
							case 4:
								document.getElementById(id).src="resources/Mizuki.png";
								break;
							case 5:
								document.getElementById(id).src="resources/oni.jpg";
								break;
							case 6:
								document.getElementById(id).src="resources/shoujo.jpg";
								break;
							case 7:
								document.getElementById(id).src="resources/sill.jpg";
								break;
							case 8:
								document.getElementById(id).src="resources/string.png";
								break;
						}
						jugador=2;
						img[imagen]=1;
