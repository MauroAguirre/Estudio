...
namespace Dominio
{
    public class Agencia
    {
        ...
        public void ModificarCliente(int codigo,string nombre,string apellido )
        {
            foreach (Cliente c in clientes)
            {
                if (c.Codigo == codigo)
        ...
        public void AltaDestino(Destino d)
        {
            destinos.Add(d);
        }
        public void BajaDestino(Destino d)
        {
            int contador = 0;
