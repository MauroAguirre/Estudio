 <%@ Page EnableEventValidation="false" Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Ingresar evento premium.aspx.cs" Inherits="Obligatorio_parte_dos.Ingresar_evento_premium" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Table runat="server" CssClass="table">
        ...
        <asp:TableRow>
            <asp:TableCell>
                <asp:Label runat="server">Aumento</asp:Label>
            </asp:TableCell>
            <asp:TableCell>
                <asp:TextBox runat="server" Type="number" ID="numAumento"></asp:TextBox>
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
            <asp:TableCell>
